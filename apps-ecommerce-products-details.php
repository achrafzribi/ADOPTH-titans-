...
if($user_data['role']=="client")
    ...
    if(isset($_GET['product_name'])){
        ...
        $stmt="SELECT * FROM `products` WHERE `product_name` ='$product_name'";
        $resultp = mysqli_query($con,$stmt);
        $product_data = mysqli_fetch_assoc($resultp);
...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Product Details | ADOPTH</title>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-7">
                                                <form class="ps-lg-4">
                                                    <!-- Product title -->
                                                    <h3 class="mt-0"> <?= $product_data['product_name'] ?> <a href="javascript: void(0);" class="text-muted"><i class="mdi mdi-square-edit-outline ms-2"></i></a> </h3>
                                                    <p class="mb-1"> <?= $product_data['date'] ?> </p>
                                                    <p class="font-16">
                                                    ...
                                                    <div class="mt-4">
                                                        ...
                                                        <h3>  <?= $product_data['product_price'] ?> </h3>
                                                    </div>
                                                    ...
                                                    <div class="mt-4">
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                ...
                                                                <p class="text-sm lh-150"><?= $product_data['quantity'] ?></p>
                                                            </div>
                                                            <div class="col-md-4">
